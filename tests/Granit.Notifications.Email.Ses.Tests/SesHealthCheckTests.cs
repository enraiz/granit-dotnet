...
/// <summary>
/// Unit tests for <see cref="SesHealthCheck"/>.
/// Only tests the exception path — happy-path requires a real SES endpoint.
/// </summary>
public sealed class SesHealthCheckTests
{
    ...
    public async Task CheckHealthAsync_UnreachableEndpoint_ReturnsUnhealthyWithSanitizedMessage()
    {
        ...
        SesHealthCheck sut = new(Microsoft.Extensions.Options.Options.Create(options));
