...
{
    private readonly SesOptionsValidator _validator = new();

    [Fact]
    public void Validate_ValidOptions_ReturnsSuccess()
    {
        SesOptions options = new() { Region = "eu-west-1", TimeoutSeconds = 30 };
    ...
    {
        SesOptions options = new() { Region = region!, TimeoutSeconds = 30 };
    ...
    {
        SesOptions options = new() { Region = "eu-west-1", TimeoutSeconds = 0 };
