...
public sealed class AzureNotificationHubsServiceCollectionExtensionsTests
{
    ...
    public void AddGranit_RegistersKeyedMobilePushSender()
    {
        ...
        services.AddGranitNotificationsMobilePushAzureNotificationHubs();
    ...
    public void AddGranit_AppliesConfigureDelegate()
    {
        ...
        services.AddGranitNotificationsMobilePushAzureNotificationHubs(opts =>
        {
    ...
    {
        ServiceCollection services = new();
        IServiceCollection result = services.AddGranitNotificationsMobilePushAzureNotificationHubs();
    ...
    public void AddGranit_WithNullConfigure_DoesNotThrow()
    {
        ...
        Should.NotThrow(() =>
            services.AddGranitNotificationsMobilePushAzureNotificationHubs(configure: null));
    }
}
