...
public sealed class GranitIdentityKeycloakModuleTests
{
    [Fact]
    public void Module_InheritsFromGranitModule()
    {
        var module = new GranitIdentityKeycloakModule();
    ...
    {
        DependsOnAttribute[] attributes = typeof(GranitIdentityKeycloakModule)
