...
/// Captures form-encoded body as string for assertion on Twilio form payloads.
/// </summary>
internal sealed class MockHttpMessageHandler : HttpMessageHandler
{
    ...
    /// <summary>Status code returned by all responses. Defaults to <see cref="HttpStatusCode.Created"/>.</summary>
