// =============================================================================
// FoundationSettingsModuleTests - Tests d'intégration DI du module Settings
// =============================================================================
// Vérifie le câblage complet des services via AddFoundation<FoundationSettingsModule>(),
...
public sealed class FoundationSettingsModuleTests
{
