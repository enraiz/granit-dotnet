...
public sealed class GroupByTests
{
    ...
    public void QueryDefinition_exposes_group_by_fields()
    {
        ...
        IReadOnlyList<Granit.Querying.Filtering.GroupByDescriptor> fields = definition.GetGroupByFields();
...
public sealed class AggregateTests
{
    ...
    public void QueryDefinition_exposes_aggregates()
    {
        ...
        IReadOnlyList<Granit.Querying.Filtering.AggregateDescriptor> aggregates = definition.GetAggregates();
