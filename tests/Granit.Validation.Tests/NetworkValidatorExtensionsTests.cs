...
public sealed class NetworkValidatorExtensionsTests
{
    ...
    public void Url_InvalidValues_FailValidation(string? url)
    {
        ...
        result.Errors[0].ErrorMessage.ShouldBe("Granit:Validation:InvalidUrl");
        result.Errors[0].ErrorCode.ShouldBe("Granit:Validation:InvalidUrl");
    }
    ...
    public void Ipv4Address_InvalidValues_FailValidation(string? ip)
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors[0].ErrorMessage.ShouldBe("Granit:Validation:InvalidIpv4Address");
        result.Errors[0].ErrorCode.ShouldBe("Granit:Validation:InvalidIpv4Address");
    }
    ...
    public void Ipv6Address_InvalidValues_FailValidation(string? ip)
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors[0].ErrorMessage.ShouldBe("Granit:Validation:InvalidIpv6Address");
        result.Errors[0].ErrorCode.ShouldBe("Granit:Validation:InvalidIpv6Address");
    }
    ...
    public void MacAddress_InvalidValues_FailValidation(string? mac)
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors[0].ErrorMessage.ShouldBe("Granit:Validation:InvalidMacAddress");
        result.Errors[0].ErrorCode.ShouldBe("Granit:Validation:InvalidMacAddress");
    }
