// =============================================================================
// Tests - FoundationCachingRedisModule
// =============================================================================
...
public sealed class FoundationCachingRedisModuleTests
{
    [Fact]
    public void ConfigureServices_IsEnabledFalse_DoesNotThrow()
    {
        ...
        // Enregistrement manuel des dépendances (FoundationCachingModule d'abord)
        FoundationCachingModule cachingModule = new();
        ServiceConfigurationContext context = new(builder.Services, builder.Configuration, builder);
        cachingModule.ConfigureServices(context);

        FoundationCachingRedisModule redisModule = new();
