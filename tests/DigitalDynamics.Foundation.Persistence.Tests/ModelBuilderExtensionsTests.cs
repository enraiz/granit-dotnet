...
// =============================================================================
// Verifies that ApplyFoundationConventions applies:
...
public sealed class ModelBuilderExtensionsTests
{
    ...
    [Fact]
    public async Task ApplyFoundationConventions_FiltersInactiveEntities()
    {
        // Arrange
    ...
    [Fact]
    public async Task ApplyFoundationConventions_ActiveFilter_IgnoreQueryFilters_ReturnsAll()
    {
        // Arrange
        await using TestDbContextWithActive context = CreateContextWithActive();
        await context.Database.EnsureCreatedAsync(TestContext.Current.CancellationToken);
    ...
    [Fact]
    public void ApplyFoundationConventions_SoftDelete_DataFilter_Bypass_EvaluatesDynamically()
    {
    ...
    [Fact]
    public void ApplyFoundationConventions_Active_DataFilter_Bypass_EvaluatesDynamically()
    {
    ...
    [Fact]
    public void ApplyFoundationConventions_CombinedEntity_HasSingleQueryFilter()
    {
    ...
    [Fact]
    public void ApplyFoundationConventions_CombinedEntity_BothFiltersActive()
    {
    ...
    [Fact]
    public void ApplyFoundationConventions_CombinedEntity_IndependentBypass()
    {
        Guid tenantA = Guid.NewGuid();
        SharedTenant.Id = tenantA;
    ...
    [Fact]
    public void ApplyFoundationConventions_NullDataFilter_FiltersAlwaysApply()
    {
    ...
    IDataFilter dataFilter) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) =>
        modelBuilder.ApplyFoundationConventions(dataFilter: _dataFilter);
}
