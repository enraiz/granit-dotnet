...
namespace Granit.DataImport.Tests.Mapping;
...
public sealed class MappingSuggestionServiceTests
{
    ...
    private readonly IOptions<DataImportOptions> _options;
    private readonly MappingSuggestionService _sut;

    public MappingSuggestionServiceTests()
    {
        _options = Options.Create(new DataImportOptions { FuzzyMatchThreshold = 0.8 });
