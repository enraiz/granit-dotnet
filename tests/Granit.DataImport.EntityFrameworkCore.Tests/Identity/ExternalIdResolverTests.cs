...
using Granit.DataImport.EntityFrameworkCore.Internal.Identity;
...
namespace Granit.DataImport.EntityFrameworkCore.Tests.Identity;
...
public sealed class ExternalIdResolverTests
{
    ...
    private static ExternalIdResolver<TestEntity, TestAppDbContext> CreateResolver(
        ...
        new(
            new InMemoryDataImportContextFactory(importDbName),
    ...
    public async Task ResolveAsync_returns_update_when_external_id_is_mapped()
    {
        ...
        await using (DataImportDbContext importContext = importFactory.CreateDbContext())
        {
