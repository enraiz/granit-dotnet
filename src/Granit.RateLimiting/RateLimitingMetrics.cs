...
public sealed class RateLimitingMetrics
{
    ...
    public RateLimitingMetrics(IMeterFactory meterFactory)
    {
        ...
        _allowedCounter = meter.CreateCounter<long>("granit.ratelimiting.requests.allowed", description: "Number of requests allowed by rate limiting.");
        _rejectedCounter = meter.CreateCounter<long>("granit.ratelimiting.requests.rejected", description: "Number of requests rejected by rate limiting.");
    }
