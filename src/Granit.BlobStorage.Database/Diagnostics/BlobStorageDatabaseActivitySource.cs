...
/// <summary>
/// Central <see cref="ActivitySource"/> for Granit.BlobStorage.Database distributed tracing.
/// </summary>
/// <remarks>
...
{
    /// <summary>The name of the Granit.BlobStorage.Database <see cref="ActivitySource"/>.</summary>
