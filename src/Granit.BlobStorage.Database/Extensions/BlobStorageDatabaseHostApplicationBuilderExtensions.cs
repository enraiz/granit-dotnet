...
public static class BlobStorageDatabaseHostApplicationBuilderExtensions
{
    ...
    /// <see cref="DatabaseBlobStorageDbContext"/>, and the <see cref="IBlobStorage"/> orchestrator.
    /// </summary>
    /// <remarks>
    /// <para>
        ...
        Action<DbContextOptionsBuilder> configure)
    {
        ...
        builder.Services.AddGranitDbContext<DatabaseBlobStorageDbContext>(configure);
