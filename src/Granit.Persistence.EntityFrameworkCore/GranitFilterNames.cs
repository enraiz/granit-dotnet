...
{
    /// <summary>Filter key for <see cref="Granit.Domain.ISoftDeletable"/> — excludes logically deleted entities.</summary>
    public const string SoftDelete = "SoftDelete";

    /// <summary>Filter key for <see cref="Granit.Domain.IActive"/> — excludes inactive entities.</summary>
    public const string Active = "Active";

    /// <summary>Filter key for <see cref="Granit.Domain.IProcessingRestrictable"/> — excludes GDPR-restricted entities.</summary>
    public const string ProcessingRestrictable = "ProcessingRestrictable";

    /// <summary>Filter key for <see cref="Granit.Domain.IMultiTenant"/> — restricts queries to the current tenant.</summary>
    public const string MultiTenant = "MultiTenant";

    /// <summary>Filter key for <see cref="Granit.Domain.IPublishable"/> — excludes unpublished entities.</summary>
    public const string Publishable = "Publishable";

    /// <summary>Filter key for <see cref="Granit.Domain.IHasMergeTombstone"/> — excludes aggregates merged out into another instance.</summary>
