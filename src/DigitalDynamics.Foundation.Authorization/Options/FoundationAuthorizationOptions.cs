namespace DigitalDynamics.Foundation.Authorization.Options;

/// <summary>Configuration options for the Foundation.Authorization module.</summary>
public sealed class FoundationAuthorizationOptions
{
