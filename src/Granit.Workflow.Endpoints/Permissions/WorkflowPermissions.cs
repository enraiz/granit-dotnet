...
public static class WorkflowPermissions
{
    ...
    /// <summary>Permissions for workflow history endpoints.</summary>
    public static class History
    {
        /// <summary>
        /// Grants access to the workflow transition history endpoint (HDS audit trail).
        /// </summary>
        public const string Default = "Workflow.History";
    }
}
