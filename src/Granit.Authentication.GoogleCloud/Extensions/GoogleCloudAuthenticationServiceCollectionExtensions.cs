using Granit.Authentication.GoogleCloud.Authentication;
using Granit.Authentication.GoogleCloud.Options;
...
namespace Granit.Authentication.GoogleCloud.Extensions;
