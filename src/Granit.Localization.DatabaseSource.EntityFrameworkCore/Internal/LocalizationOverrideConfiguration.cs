...
/// Table: <c>granit_localization_overrides</c>.
/// </summary>
    ...
    : IEntityTypeConfiguration<LocalizationOverride>
{
    ...
    {
        builder.ToTable("granit_localization_overrides");
        ...
        builder.HasIndex(e => new { e.TenantId, e.ResourceName, e.CultureName, e.Key })
               .IsUnique()
               .HasDatabaseName("uq_granit_localization_overrides_tenant_resource_culture_key");
        ...
        builder.HasIndex(e => new { e.TenantId, e.ResourceName, e.CultureName })
               .HasDatabaseName("ix_granit_localization_overrides_tenant_resource_culture");
    }
}
