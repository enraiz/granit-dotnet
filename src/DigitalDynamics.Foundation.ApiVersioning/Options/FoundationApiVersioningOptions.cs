namespace DigitalDynamics.Foundation.ApiVersioning.Options;

/// <summary>Configuration options for Foundation API versioning.</summary>
public sealed class FoundationApiVersioningOptions
{
