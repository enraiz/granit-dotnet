using DigitalDynamics.Foundation.Diagnostics.ResponseWriters;
...
/// <summary>
/// Extensions for mapping Foundation health check endpoints.
/// </summary>
public static class DiagnosticsEndpointRouteBuilderExtensions
{
    ...
    /// </list>
    /// </remarks>
    public static IEndpointRouteBuilder MapFoundationHealthChecks(
