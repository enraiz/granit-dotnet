...
namespace Granit.Notifications.MobilePush.AzureNotificationHubs.Diagnostics;
...
/// </remarks>
internal static class NotificationsMobilePushAnhActivitySource
{
    /// <summary>Activity source name.</summary>
    public const string Name = "Granit.Notifications.MobilePush.AzureNotificationHubs";
