...
namespace DigitalDynamics.Foundation.Caching.Extensions;

/// <summary>
/// Extensions d'enregistrement DI pour <c>DigitalDynamics.Foundation.Caching</c>.
/// </summary>
public static class CachingServiceCollectionExtensions
{
    /// <summary>
    /// Enregistre le système de cache Foundation avec le fournisseur <c>MemoryDistributedCache</c> par défaut.
    /// </summary>
    /// <remarks>
    ...
    ///   <item><see cref="IMemoryCache"/> dédié (clé <c>DigitalDynamics.Foundation.Caching.Locks</c>) pour la protection stampede</item>
    ...
    public static IServiceCollection AddFoundationCaching(
