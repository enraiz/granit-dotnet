...
namespace Granit.BlobStorage.FileSystem.Diagnostics;

/// <summary>
/// Central <see cref="ActivitySource"/> for Granit.BlobStorage.FileSystem distributed tracing.
/// </summary>
/// <remarks>
/// <c>Granit.Observability</c> adds this source automatically via
/// <c>GranitActivitySourceRegistry</c> when both packages are used.
/// </remarks>
internal static class BlobStorageFileSystemActivitySource
{
    /// <summary>The name of the Granit.BlobStorage.FileSystem <see cref="ActivitySource"/>.</summary>
    internal const string Name = "Granit.BlobStorage.FileSystem";
    ...
    internal const string TagBasePath = "blobstorage.base_path";
