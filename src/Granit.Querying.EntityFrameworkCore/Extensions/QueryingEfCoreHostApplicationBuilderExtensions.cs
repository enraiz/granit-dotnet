...
public static class QueryingEfCoreHostApplicationBuilderExtensions
{
    ...
    /// <c>QueryingDbContext</c> and <see cref="ISavedViewStore"/> implementation.
    /// </summary>
    ...
    {
        builder.Services.AddDbContextFactory<QueryingDbContext>(configure);

        // Replace the null-object default from Granit.Querying
        builder.Services.AddScoped<ISavedViewStore, EfCoreSavedViewStore>();
