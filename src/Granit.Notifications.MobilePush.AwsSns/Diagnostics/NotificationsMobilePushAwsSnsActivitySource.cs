...
namespace Granit.Notifications.MobilePush.AwsSns.Diagnostics;

/// <summary>OpenTelemetry activity source for the AWS SNS mobile push provider.</summary>
internal static class NotificationsMobilePushAwsSnsActivitySource
{
    /// <summary>Activity source name.</summary>
    public const string Name = "Granit.Notifications.MobilePush.AwsSns";
