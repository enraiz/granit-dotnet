...
public interface IFeatureChecker
{
    ...
    /// </summary>
    /// <exception cref="Exceptions.FeatureNotFoundException">If the feature is not declared.</exception>
    Task<long> GetNumericAsync(string featureName, CancellationToken ct = default);

    /// <summary>
    /// Returns the raw resolved string value for a feature.
    /// </summary>
    /// <exception cref="Exceptions.FeatureNotFoundException">If the feature is not declared.</exception>
    Task<string> GetValueAsync(string featureName, CancellationToken ct = default);
    ...
    Task RequireEnabledAsync(string featureName, CancellationToken ct = default);
}
